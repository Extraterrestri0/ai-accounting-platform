...
<link rel="stylesheet" href="/landing/assets/tokens.css?v=17" />
<link rel="stylesheet" href="/landing/assets/site.css?v=17" />
    ...
    <nav class="nav-links" aria-label="Основна навигация">
      <div class="has-dd">
        ...
        <div class="dd-panel dd-feat">
          ...
          <a class="dd-item" href="/features#dive-invoice"><span class="ic"><i data-lucide="file-text"></i></span><span><b>Фактуриране</b><span>Издаване с номерация и PDF</span></span></a>
      ...
      <div class="has-dd">
        ...
        <div class="dd-panel dd-res">
          <a class="dd-item" href="/features"><span class="ic"><i data-lucide="sparkles"></i></span><span><b>Без счетоводител</b><span>Водете си сметките сами</span></span></a>
          <a class="dd-item" href="/features"><span class="ic"><i data-lucide="store"></i></span><span><b>Малки фирми и ЕООД</b><span>Самостоятелно счетоводство</span></span></a>
...
<footer class="footer">
  <div class="wrap">
    ...
    <div class="foot-bottom">
      <span class="cp">© <span data-year>2026</span> MGI-Delta. Всички права запазени. · EUR · ЕС</span>
...
<script src="/landing/assets/i18n.js?v=17" defer></script>
<script src="/landing/assets/site.js?v=17" defer></script>
...
S.trust = `
<section class="trustbar"><div class="wrap"><span class="tb-label">Създадено за България</span><div class="tb-chips"><span class="chip"><span class="dot"></span>ЕИК и VIES</span><span class="chip"><span class="dot"></span>ДДС 20 / 9 / 0 %</span><span class="chip"><span class="dot"></span>EUR</span><span class="chip"><span class="dot"></span>Хостинг в ЕС</span><span class="chip"><span class="dot"></span>AI без задържане на данни</span></div></div></section>`;
...
<section class="stats" id="stats"><div class="wrap" style="padding-inline:0"><div class="stats-grid">
  ...
  <div class="stat reveal" data-delay="3"><div class="sv grad-text"><span data-count="4.9" data-dec="1"></span></div><div class="sl">средна оценка<br />от потребители</div></div>
</div></div></section>`;
...
S.features = (seeAll) => `
<section class="section-pad" id="features"><div class="wrap"><div class="section-head reveal"><span class="eyebrow">Възможности</span><h2 class="section-title">Всичко за обработката<br />на документи</h2><p class="section-sub">Всичко, за да водите счетоводството на бизнеса си сами — създадено за България.</p></div><div class="feat-grid">
...
S.testimonials = `
<section class="section-pad" id="testimonials"><div class="wrap"><div class="section-head reveal"><span class="eyebrow">Отзиви</span><h2 class="section-title">Малки фирми и самонаети,<br />които си водят сметките сами</h2><p class="section-sub">Истории на хора, които управляват финансите си без счетоводител.</p></div><div class="tcar reveal"><div class="tcar-track">
  <div class="tslide"><article class="card tcard"><div class="stars"><i data-lucide="star"></i><i data-lucide="star"></i><i data-lucide="star"></i><i data-lucide="star"></i><i data-lucide="star"></i></div><blockquote>„Нямам счетоводител. Качвам фактурите, AI ги разчита, аз одобрявам — и ДДС-то ми е готово за минути.“</blockquote><div class="who"><span class="av">МД</span><div><div class="wn">Мартин Делчев</div><div class="wr">Собственик · онлайн магазин</div></div></div></article></div>
  ...
  <div class="tslide"><article class="card tcard"><div class="stars"><i data-lucide="star"></i><i data-lucide="star"></i><i data-lucide="star"></i><i data-lucide="star"></i><i data-lucide="star"></i></div><blockquote>„Спестявам това, което плащах на счетоводител. Сама въвеждам и одобрявам, а отчетите са винаги под ръка.“</blockquote><div class="who"><span class="av">ИК</span><div><div class="wn">Илина Кирова</div><div class="wr">Управител · малка фирма</div></div></div></article></div>
  ...
  <div class="tslide"><article class="card tcard"><div class="stars"><i data-lucide="star"></i><i data-lucide="star"></i><i data-lucide="star"></i><i data-lucide="star"></i><i data-lucide="star"></i></div><blockquote>„Не разбирам от счетоводство, но платформата ми казва какво дължа и кога. Усещането за контрол е безценно.“</blockquote><div class="who"><span class="av">ВТ</span><div><div class="wn">Виктор Танев</div><div class="wr">Управител · малка фирма</div></div></div></article></div>
  <div class="tslide"><article class="card tcard"><div class="stars"><i data-lucide="star"></i><i data-lucide="star"></i><i data-lucide="star"></i><i data-lucide="star"></i><i data-lucide="star"></i></div><blockquote>„Като самонаета нямах нужда от цял счетоводител. Тук издавам фактури и следя приходите за минути.“</blockquote><div class="who"><span class="av">РН</span><div><div class="wn">Ралица Николова</div><div class="wr">Самонаета · маркетинг</div></div></div></article></div>
...
<section class="section-pad" id="faq"><div class="wrap"><div class="section-head reveal"><span class="eyebrow">Въпроси</span>${asH1 ? '<h1 class="section-title">Често задавани въпроси</h1>' : '<h2 class="section-title">Въпроси и отговори</h2>'}<p class="section-sub">Не намирате отговор? Пишете ни, отговаряме на български.</p></div><div class="faq reveal">
  ...
  <details class="faq-item"><summary class="faq-q">Трябва ли ми счетоводител, за да я ползвам?<span class="pm"><i data-lucide="plus" style="width:17px;height:17px"></i></span></summary><div class="faq-a">Не. Платформата е създадена да си водите счетоводството сами — AI разчита документите и предлага осчетоводяване, а вие само одобрявате. Подходяща е за самонаети, фрийлансъри и малки фирми, без нужда от счетоводител.</div></details>
</div></div></section>`;
...
const PAGES = [
  ...
  { key: 'pricing', file: 'pricing.html', url: '/pricing', title: 'Цени и планове · MGI-Delta',
    ...
    body: S.pricing + S.faq(false) + S.finalCta },
  { key: 'about', file: 'about.html', url: '/about', title: 'За нас · MGI-Delta',
    ...
    body: S.aboutIntro + S.security + S.testimonials + S.finalCta },
  ...
  { key: 'faq', file: 'faq.html', url: '/faq', title: 'Често задавани въпроси · MGI-Delta',
    ...
    jsonld: { '@context': 'https://schema.org', '@type': 'FAQPage', mainEntity: [
      ...
      ['Поддържа ли български фирми и формати?', 'Да — ЕИК, VIES, ДДС 20/9/0%, национален сметкоплан, кирилица, EUR.'],
