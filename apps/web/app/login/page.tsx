    ...
    <div className="grid min-h-screen lg:grid-cols-2">
        ...
        <div className="relative flex h-full flex-col justify-between p-12 text-white">
          ...
          <div className="max-w-md space-y-7">
            <span className="inline-flex items-center gap-2 rounded-full border border-white/15 bg-white/10 px-3.5 py-1.5 text-xs font-semibold text-white/90 backdrop-blur-sm">
              <Sparkles className="h-3.5 w-3.5 text-white" /> AI счетоводство · MVP
            </span>
            <h1 className="text-[2.6rem] font-extrabold leading-[1.06] tracking-tight">{t('auth.loginTitle')}</h1>
          ...
          <p className="text-xs text-white/55">EUR · BGN · EU · Хостинг в ЕС</p>
        </div>
      </div>
      ...
      <div className="relative flex items-center justify-center p-6 sm:p-12">
        ...
        <div className="w-full max-w-sm">
          ...
          <div className="mb-8">
            <h2 className="text-[28px] font-extrabold leading-tight tracking-tight">{t('auth.loginTitle')}</h2>
