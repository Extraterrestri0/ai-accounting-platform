...
const COMPANY_ROLE_PERMS: Record<CompanyRole, Permission[]> = {
  ...
  accountant: [P.COMPANY_READ, P.LEDGER_READ, P.LEDGER_POST, P.LEDGER_REVERSE, P.VAT_READ, P.DOCUMENT_UPLOAD, P.REVIEW_APPROVE, P.MASTERDATA_READ, P.MASTERDATA_WRITE, P.INVOICE_READ, P.INVOICE_CREATE, P.INVOICE_ISSUE, P.INVOICE_SEND],
  approver: [P.COMPANY_READ, P.LEDGER_READ, P.VAT_READ, P.VAT_SUBMIT, P.REVIEW_APPROVE, P.MASTERDATA_READ, P.INVOICE_READ],
  viewer: [P.COMPANY_READ, P.LEDGER_READ, P.VAT_READ, P.MASTERDATA_READ, P.INVOICE_READ],
};
