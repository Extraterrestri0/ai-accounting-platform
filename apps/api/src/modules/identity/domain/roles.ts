...
const COMPANY_ROLE_PERMS: Record<CompanyRole, Permission[]> = {
  ...
  accountant: [P.COMPANY_READ, P.LEDGER_READ, P.LEDGER_POST, P.LEDGER_REVERSE, P.VAT_READ, P.DOCUMENT_UPLOAD, P.REVIEW_APPROVE, P.MASTERDATA_READ, P.MASTERDATA_WRITE, P.INVOICE_READ, P.INVOICE_CREATE, P.INVOICE_ISSUE, P.INVOICE_SEND, P.PAYMENT_READ, P.PAYMENT_RECORD, P.PAYMENT_REVERSE, P.AUDIT_READ, P.PERIOD_READ, P.PERIOD_MANAGE, P.BANK_READ, P.BANK_MANAGE, P.BANK_RECONCILE, P.SAFT_READ, P.SAFT_GENERATE],
  approver: [P.COMPANY_READ, P.LEDGER_READ, P.VAT_READ, P.VAT_SUBMIT, P.REVIEW_APPROVE, P.MASTERDATA_READ, P.INVOICE_READ, P.PAYMENT_READ, P.AUDIT_READ, P.PERIOD_READ, P.BANK_READ, P.SAFT_READ],
  viewer: [P.COMPANY_READ, P.LEDGER_READ, P.VAT_READ, P.MASTERDATA_READ, P.INVOICE_READ, P.PAYMENT_READ, P.AUDIT_READ, P.PERIOD_READ, P.BANK_READ, P.SAFT_READ],
};
