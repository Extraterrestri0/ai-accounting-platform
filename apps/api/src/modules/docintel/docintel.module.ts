...
import { StubOcrProvider } from './infrastructure/stub-ocr-provider';
import { DefaultOcrProvider } from './infrastructure/default-ocr-provider';
 ...
 */
@Module({
  imports: [AuditModule, MasterDataModule, LedgerModule],
  controllers: [DocumentsController, ExtractionsController, SuggestionsController, ReviewsController, PostingsController],
  providers: [
    ...
    { provide: OCR_PROVIDER, useClass: process.env.OCR_REAL === 'false' ? StubOcrProvider : DefaultOcrProvider },
